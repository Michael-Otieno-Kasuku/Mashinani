# Generated by Django 5.0.2 on 2024-02-22 10:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.account')),
                ('constituency_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.constituency')),
                ('financial_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.financialyear')),
                ('institution_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.institution')),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.student')),
                ('voter_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mashinani.voter')),
            ],
        ),
    ]
